...
public class GetDetailSupplierTask implements Task {
    private final String supplierId;

    public GetDetailSupplierTask(String supplierId) {
    ...
    public static GetDetailSupplierTask withSupplierId(String supplierId) {
        return new GetDetailSupplierTask(supplierId);
    }
}
