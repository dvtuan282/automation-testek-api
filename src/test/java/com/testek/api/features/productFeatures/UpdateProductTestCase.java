...
//    @MethodSource("provideProductSuccess")
    ...
    void updateProjectSuccess() {
        ProductModel productRequest = new ProductModel("130c930a-62cf-4d9e-b6e2-19b8645b00a8", "6a0895ef-2b58-473e-9278-50e9aac7df87", "Update success 1", "update name success 1", 200.0, 30, "kg", "code103");
        actor.attemptsTo(
                UpdateProductTask.withProduct(productId, productRequest),
                Ensure.that(StatusCodeResponse.responseStatus()).isEqualTo(400)
        );
        int StatusCode = actor.asksFor(StatusCodeResponse.responseStatus());
        if (StatusCode == 200)
            actor.attemptsTo(
...
//        return Stream.of(
//                Arguments.of(new ProductModel("130c930a-62cf-4d9e-b6e2-19b8645b00a8", "6a0895ef-2b58-473e-9278-50e9aac7df87", "Update success 1", "update name success 1", 200.0, 30, "kg", "code103")));
//    }
}
